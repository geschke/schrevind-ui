      ...
      sub: [
        { title: "nav.items.overview", type: "item", icon: "bi bi-grid-1x2", url: "/overview" },
        {
          ...
          sub: [
            ...
            { title: "analyses.dividends_by_security_year_data.title", type: "item", icon: "bi bi-graph-up", url: "/analytics/security-years-data" },
            { title: "analyses.dividends_by_security_year.titleAlt", type: "item", icon: "bi bi-graph-up", url: "/analytics/security-years" },
            { title: "analyses.dividends_by_year_month_security.title", type: "item", icon: "bi bi-table", url: "/analytics/month-security" },
          ],
        },
