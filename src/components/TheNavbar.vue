...
{ title: "analyses.dividends_by_year_month_security.titleAlt", type: "item", icon: "bi bi-table", url: "/analytics/month-security" },
            { title: "analyses.dividends_by_year_month_security_data.title", type: "item", icon: "bi bi-table", url: "/analytics/month-security-v2" },
          ],
        },
